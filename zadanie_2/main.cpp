...
int main(){
	...
	std::cout<<"Z kolei konstruktor kopiujacy zapewnia kopiowanie obiektu, lecz nie adresu wiec mozemy bezpiecznie wykonywac wszelkie operacje na jego kopii utworzonej z pomoca konstruktora kopiujacego"<<std::endl;
	return 0;
}
